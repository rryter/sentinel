...
export class LintResultsComponent {
  ...
  violationsData = signal<ApiV1ViolationsGet200Response | null>(null);
  ...
  isLoading = computed(
    () => this.resultsData() === null || this.violationsData() === null,
  );
  constructor(
    private analysisJobService: AnalysisJobsService,
